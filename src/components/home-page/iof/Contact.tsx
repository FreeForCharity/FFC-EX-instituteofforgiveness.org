      ...
      <div className="mx-auto w-[92%] max-w-[1180px]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-[40px] items-start">
          <div className="lg:col-span-5">
            ...
            <h2 className="text-[34px] md:text-[42px] font-[500] text-[#3D1E4D] leading-[115%] mb-[20px] faustina-font">
              Reach the Institute.
            </h2>
            <p className="text-[17px] leading-[170%] text-[#2A1430]/80 max-w-[440px] lato-font">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-[18px] lato-font">
            <a
              href="tel:8049186195"
            ...
            >
              <span className="text-[12px] uppercase tracking-[0.24em] text-[#7A3B7E] mb-[10px] aria-font">
                Phone
              </span>
            ...
            >
              ...
              <span className="mt-[10px] text-[13px] text-[#2A1430]/65 aria-font">
            ...
            <div className="flex flex-col rounded-[18px] border border-[#3D1E4D]/20 bg-[#FBF6EC] p-[24px] sm:col-span-2">
              <span className="text-[12px] uppercase tracking-[0.24em] text-[#7A3B7E] mb-[14px] aria-font">
                Follow the work
              </span>
