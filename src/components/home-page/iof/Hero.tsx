    ...
    >
      ...
      <div className="relative z-10 mx-auto w-[92%] max-w-[1180px] flex flex-col lg:flex-row items-center gap-[40px] lg:gap-[60px]">
        <div className="w-full lg:w-[58%] text-white">
          <p className="text-[14px] uppercase tracking-[0.28em] text-[#F5C76A] mb-[18px] aria-font">
            Institute of Forgiveness
          </p>
          <h1 className="text-[40px] md:text-[52px] lg:text-[60px] font-[500] leading-[110%] mb-[24px] faustina-font">
            The key to ending mass incarceration is{' '}
            <span className="text-[#F5C76A] italic">forgiveness</span>.
          </h1>
          <p className="text-[18px] md:text-[20px] leading-[150%] text-white/85 mb-[36px] max-w-[620px] lato-font">
          ...
          <div className="flex flex-wrap gap-[14px]">
            <Link
              href="#donate"
              className="inline-flex h-[54px] items-center justify-center rounded-full bg-[#F5C76A] px-[34px] text-[17px] font-[600] text-[#3D1E4D] transition hover:bg-[#FFD888] lato-font"
            >
              Donate Now
            </Link>
            <Link
              href="#programs"
              className="inline-flex h-[54px] items-center justify-center rounded-full border-2 border-white/80 bg-transparent px-[34px] text-[17px] font-[500] text-white transition hover:bg-white/10 lato-font"
            >
              Our Programs
            </Link>
            <Link
              href="#contact"
              className="inline-flex h-[54px] items-center justify-center rounded-full bg-white/10 px-[34px] text-[17px] font-[500] text-white backdrop-blur transition hover:bg-white/20 lato-font"
            >
              Get in Touch
            </Link>
          </div>
        ...
        <div className="w-full lg:w-[42%]">
          <div className="relative rounded-[28px] bg-white/[0.14] backdrop-blur-md border border-white/30 p-[32px] lg:p-[40px] shadow-2xl">
            ...
            <blockquote className="text-white text-[20px] md:text-[22px] leading-[145%] font-[400] pt-[16px] faustina-font">
            ...
            <div className="mt-[24px] flex items-center gap-[14px]">
              <div className="h-[44px] w-[44px] rounded-full bg-[#F5C76A] flex items-center justify-center text-[#3D1E4D] font-[700] text-[18px] cinzel">
                SW
              </div>
              <div>
                <p className="text-white text-[16px] font-[600] lato-font">Sheba Williams</p>
                <p className="text-white/70 text-[14px] lato-font">
