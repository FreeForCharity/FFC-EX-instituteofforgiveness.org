    ...
    <main className="bg-[#FBF6EC]">
      <section className="bg-gradient-to-br from-[#3D1E4D] via-[#5B2A6B] to-[#7A3B7E] py-[120px] text-white">
        <div className="mx-auto w-[92%] max-w-[1080px]">
          ...
          <h1
            className="text-[42px] md:text-[56px] font-[500] leading-[115%] max-w-[820px] mb-[20px]"
            id="faustina-font"
          >
            Your donation funds real second chances.
          </h1>
          <p className="text-[18px] leading-[170%] text-white/85 max-w-[680px]" id="lato-font">
      ...
      <section className="py-[80px] lg:py-[110px]">
        <div className="mx-auto w-[92%] max-w-[1080px]">
          <h2
            className="text-[30px] md:text-[36px] font-[500] text-[#3D1E4D] leading-[120%] mb-[36px] max-w-[680px]"
            id="faustina-font"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[18px]">
            {tiers.map((tier) => (
              ...
              >
                <span
                  className="block text-[40px] font-[600] text-[#7A3B7E] leading-none mb-[12px]"
                  id="faustina-font"
                >
                  {tier.amount}
                </span>
          ...
          <p
            className="mt-[40px] text-[14px] leading-[170%] text-[#2A1430]/70 max-w-[820px]"
            id="lato-font"
          >
